...
open class JXPhotoBrowserImageCell: UIView, UIScrollViewDelegate, UIGestureRecognizerDelegate, JXPhotoBrowserCell, JXPhotoBrowserZoomSupportedCell {
    ...
    /// 已添加的长按手势
    private lazy var longPress: UILongPressGestureRecognizer = .init(target: self, action: #selector(onLongPress(_:)))
    ...
    /// 单击
    @objc open func onSingleTap(_: UITapGestureRecognizer) {
