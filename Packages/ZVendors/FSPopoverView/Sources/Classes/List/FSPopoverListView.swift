        ...
        if let items = items {
            ...
            do {
                ...
                if autosetsArrowDirection {
                    ...
                    if downMaxSize.width >= contentSize.width && downMaxSize.height >= contentSize.height {
                        maxSize = downMaxSize
                    } else if upMaxSize.width >= contentSize.width && upMaxSize.height >= contentSize.height {
                        maxSize = upMaxSize
