//
//  HeroImageViewAligned.swift
//  HeroImageViewAlignedSwift
//
//  MIT License.
//
...
@IBDesignable
open class HeroImageViewAligned: UIImageView {
    /**
    ...
    /**
     ...
     Accessible to keep compatibility with the original `HeroImageViewAligned`.
     */
