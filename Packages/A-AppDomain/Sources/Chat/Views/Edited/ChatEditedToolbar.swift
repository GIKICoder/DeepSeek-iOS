...
class ChatEditedToolbar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        checkBox = {
            ...
            button.setImage(UIImage(named: "chat_select"), for: .normal)
            button.setImage(UIImage(named: "chat_un_select"), for: .selected)
            addSubview(button)
            return button
        }()
        ...
        titleLabel = {
            ...
            label.text = NSLocalizedString("全选", comment: "")
            addSubview(label)
            return label
        }()
        ...
        countLabel = {
            ...
            label.textAlignment = .left
            label.text = String(format: NSLocalizedString("%ld 个消息被选择", comment: ""), 0)
        ...
        shareBtn = {
            ...
            button.setTitle(NSLocalizedString("一键转文档", comment: ""), for: .normal)
