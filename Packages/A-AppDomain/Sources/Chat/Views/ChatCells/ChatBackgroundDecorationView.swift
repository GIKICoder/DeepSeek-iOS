...
final class ChatBackgroundDecorationView: MagazineLayoutCollectionReusableView {

    typealias Model = ChatSection
...
extension ChatBackgroundDecorationView: EditNotifierDelegate {
