...
public enum DeepSeekAsset: Sendable {
  ...
  public static let frame1095Normal = DeepSeekImages(name: "Frame 1095_Normal")
    ...
    public static let claudeIc = DeepSeekImages(name: "claude_ic")
    public static let deepseekIc = DeepSeekImages(name: "deepseek_ic")
    public static let geminiaiIc = DeepSeekImages(name: "geminiai_ic")
    public static let localmodelIc = DeepSeekImages(name: "localmodel_ic")
    public static let openaiIc = DeepSeekImages(name: "openai_ic")
